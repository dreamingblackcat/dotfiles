...
echo ""
echo "  Test with LOCAL repo (mounted at /home/chan/dotfiles, chezmoi-migration branch):"
echo "    chezmoi init --apply --source=/home/chan/dotfiles --branch chezmoi-migration"
echo ""
echo "  Test pulling from GitHub (chezmoi-migration branch):"
echo "    chezmoi init --apply github.com/dreamingblackcat/dotfiles --branch chezmoi-migration"
echo ""
